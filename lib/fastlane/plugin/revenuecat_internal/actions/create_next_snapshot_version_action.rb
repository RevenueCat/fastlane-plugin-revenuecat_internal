  ...
  module Actions
    class CreateNextSnapshotVersionAction < Action
      def self.run(params)
        ...
        Helper::RevenuecatInternalHelper.create_pr("Prepare next version: #{next_version_snapshot}", nil, repo_name, "main", new_branch_name, github_pr_token, labels: [label], enable_auto_merge: true)
      end
